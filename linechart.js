...
const m_l = { top: 30, right: 30, bottom: 30, left: 30 };
const g_l = svg_l.append("g").attr("transform", "translate(30, 30)");
// 实际我们图的高度宽度
...
function drawLineChart(showCircle = true){
  ...
  let minX = d3.min(datas,item => item[0]);
  let maxX = d3.max(datas,item => item[0]);
